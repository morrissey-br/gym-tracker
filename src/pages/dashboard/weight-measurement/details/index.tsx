    ...
    <div className="flex flex-col justify-center items-center">
      ...
      {weightMeasurements.length > 0 ? (
        <table className="w-80 border-collapse">
          <thead>
            <tr>
              <th className="text-center border border-light p-2">Data</th>
              <th className="text-center border border-light p-2">Peso</th>
              <th className="text-center border border-light p-2">Ações</th>
            </tr>
          </thead>
          <tbody>
            {weightMeasurements.map((weightMeasurement) => (
              <tr key={weightMeasurement.date.toString()}>
                <td className="text-center border border-light p-2">
